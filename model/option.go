...
func InitOptionMap() {
	...
	common.OptionMap["ChannelKeyVerificationEnabled"] = strconv.FormatBool(common.ChannelKeyVerificationEnabled)
	...
	common.OptionMap["MaskSecretsEnabled"] = strconv.FormatBool(setting.MaskSecretsEnabled)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" {
		...
		case "ChannelKeyVerificationEnabled":
			common.ChannelKeyVerificationEnabled = boolValue
		case "DrawingEnabled":
		...
		case "MaskSecretsEnabled":
			setting.MaskSecretsEnabled = boolValue
		case "SMTPSSLEnabled":
